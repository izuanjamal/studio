      ...
      <CardContent className="flex flex-col items-center text-center">
        <div className="bg-primary/10 text-primary p-6 rounded-full">
            <div className="bg-primary/20 p-8 rounded-full">
                <p className="text-5xl font-extrabold">{assignment.parkingLotNumber}</p>
            </div>
        </div>
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="flex flex-col items-center gap-4 py-4">
              ...
              <div className="w-full space-y-3 text-sm">
                <InfoRow icon={<User className="h-4 w-4 text-muted-foreground" />} label="Resident" value={assignment.residentName} />
                <Separator />
                <InfoRow icon={<Building className="h-4 w-4 text-muted-foreground" />} label="Unit No." value={assignment.unitNumber} />
                 <Separator />
